package com.jsksolutions.features.base;
...
import com.jsksolutions.injection.component.ConfigPersistentComponent;
import com.jsksolutions.injection.component.DaggerConfigPersistentComponent;
import com.jsksolutions.injection.component.FragmentComponent;
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(MuInfoApplication.get(getActivity()).getComponent())
                            .build();
